# Script for downloading SNOTEL data within project areas of interest
...
# Will warn/skip if already exists
#dir.create("data", showWarnings = T)
#dir.create("data/snotel", showWarnings = T)

# Identify SNOTEL sites of interest
# sites <- c(663, 838) # 663 = Niwot, 838 = University Camp
# 564 = Lake Eldora
sites <- 838 
